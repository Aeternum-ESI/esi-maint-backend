-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STAFF', 'TECHNICIAN', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "Technician" ADD CONSTRAINT "Technician_professionId_fkey" FOREIGN KEY ("professionId") REFERENCES "Profession"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TechnicianAvailability" ADD CONSTRAINT "TechnicianAvailability_technicianId_fkey" FOREIGN KEY ("technicianId") REFERENCES "Technician"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
